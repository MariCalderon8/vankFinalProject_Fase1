...
export class AiService {
    ...
    initChat(){
        ...
        let systemContext = `
            ...
            - Sólo saluda si no has saludado antes en la conversación, en caso de ser la primera vez o luego de que te vuelvan a saludar da la bienvenida al asistente financier de GestionPro
            ...
            - Sólo tienes acceso a las ventas del usuario, por lo que si se necesita información de productos o clientes que no están, debes pedirselo al usuario
